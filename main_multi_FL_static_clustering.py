...
if __name__ == '__main__':
    ...
    log_name = "log_file/" + "FL" + "_static_clustering_dataset_" + str(dataset) + "_NN_" + neural_network + "_clients_" + str(
    ...
    logging.info('Confidence filtering : %f', conf_filter)
    logging.info('Percentage of noise added to training : %f', percentage_of_noise)
